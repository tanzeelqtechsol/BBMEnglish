    ...
    public partial class MasterFrom : Form, IDisposable
    {
        ...
        public MasterFrom()
        {
           ...
           // ObjGetDate = new HijriToGregs();
            ...
            GeneralFunction.workstationName = GetHDDAddress();
            //GeneralFunction.Trace("MasterFrom Const END");
        }
        ...
        private void LoadSubMenus(string StrType, int NoofSubMenus, int YLocation)
        {
            ...
            SetPanelXY = flp_MainButtons.Location.X - 218;
        ...
        void Registration()
        {
            try
            {
                ...
                if ((_regkey.OpenSubKey(GeneralFunction.RegEditPath)) != null)
                {
                    ...
                    var myMachineID = LicensenceObjectClass.MotherBoardID();
        ...
        private void LogInCheck()
        {
            ...
            //string a = GeneralFunction.Decrypt("Kx1lLp6t1mckxMsYrHVLng ==");
        ...
        void ShowControls()
        {
            ...
            picLogo.Visible = true;
            picLogo.Location = new Point(((this.Size.Width / 2) - (picLogo.Size.Width / 2)), ((this.Size.Height / 6) - (picLogo.Size.Height / 6)));
            menuStrip1.Enabled = true;
            toolStrip1.Enabled = true;
            btnChangeUser.Visible = true;
            btnExit.Visible = true;
